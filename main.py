...
def checkWinner(player):
    ...
    if won:
        ...
        square_group.empty()
        background = p.image.load(player.upper() + ' Wins.jpg')
...
def CompMove():
    ...
    if not move:
        ...
        time.sleep(1)
        square_group.empty()
        background = p.image.load('Tie Game.jpg')
        background = p.transform.scale(background, (WIDTH, HEIGHT))
...
blank_image = p.image.load('E:/Intermediate Python/Projects/Tic Tac Toe/blank.jpg')
x_image = p.image.load('E:/Intermediate Python/Projects/Tic Tac Toe/x.png')
o_image = p.image.load('E:/Intermediate Python/Projects/Tic Tac Toe/o.png')
background = p.image.load('E:/Intermediate Python/Projects/Tic Tac Toe/background.jpg')

background = p.transform.scale(background, (WIDTH, HEIGHT))
button_img = p.image.load('E:/Intermediate Python/Projects/Tic Tac Toe/restart.png')
